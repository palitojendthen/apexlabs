...
//   return (
//     <main className="min-h-screen flex flex-col items-center justify-center pt-14 px-6 bg-white text-black dark:bg-gradient-to-b dark:from-black dark:to-slate-950 dark:text-white transition-colors duration-300 opacity-80">
//       <BackgroundFX />

//       <div className="w-full max-w-sm p-9 rounded-2xl bg-white/5 dark:bg-white/5 border dark:border-white/10 backdrop-blur-md shadow-xl">
...
//           <button className="border border-neutral-700 py-2 rounded hover:bg-neutral-800 transition text-sm">
